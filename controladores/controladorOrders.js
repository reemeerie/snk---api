...
const creoUnaOrder = async (req, res) => {
  ...
  /* aca no uso el authmiddleware porque no necesito ser admin para crear una orden de compra, solo necesito que el jwt sea valido */
  ...
  if (
    !request.buyer.nombre ||
    !request.buyer.apellido ||
    !request.buyer.dni ||
    !request.buyer.provincia ||
    !request.buyer.ciudad ||
    !request.buyer.direccion ||
    !request.buyer.codigoPostal ||
    !request.buyer.telefono ||
    !request.items ||
    !request.total
  ) {
